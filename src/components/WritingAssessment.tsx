...
const WritingAssessment: React.FC = () => {
  ...
  const taskTypes = [
    { id: 'business_email', name: 'Business Email', icon: '📧' },
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Select Writing Task</h3>
      ...
      {taskDetails && (
        <div className="bg-blue-50 rounded-lg border border-blue-200 p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-3">{taskDetails.title}</h3>
      ...
      {/* Writing Area */}
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Your Document</h3>
